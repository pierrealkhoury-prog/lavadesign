...
export const TEAM: DisciplineGroup[] = [
  {
    ...
    members: [
      ...
      },
      {
        ...
        office: "Houston",
        bio: "Keeps the practice moving — clients, contracts, schedule. The reason a project that starts in conversation actually gets built, on time, by the people who promised it.",
        photo: face(3),
      },
    ],
  },
